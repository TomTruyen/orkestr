...
@Composable
internal fun ChargeStateTriggerDefinitionScreenshotTest() {
    ChargeStateTriggerDefinitionComposePreview()
}
...
@Preview(showBackground = true, widthDp = 420)
@Composable
internal fun ShowNotificationActionDefinitionScreenshotTest() {
    ShowNotificationActionDefinitionComposePreview()
}

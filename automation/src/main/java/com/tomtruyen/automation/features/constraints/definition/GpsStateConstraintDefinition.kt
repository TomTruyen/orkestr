...
object GpsStateConstraintDefinition : ConstraintDefinition<GpsStateConstraintConfig>(
    configClass = GpsStateConstraintConfig::class,
    defaultConfig = GpsStateConstraintConfig(),
) {
    override val titleRes = R.string.automation_definition_constraint_gps_title
    override val descriptionRes = R.string.automation_definition_constraint_gps_description
    override val fields = listOf(
        TypedAutomationFieldDefinition(
            configClass = GpsStateConstraintConfig::class,
            defaultConfig = defaultConfig,
            id = "enabled",
            labelRes = R.string.automation_definition_constraint_gps_field_label,
            type = AutomationFieldType.BOOLEAN,
            descriptionRes = R.string.automation_definition_constraint_gps_field_description,
    ...
    override fun summarize(config: GpsStateConstraintConfig, resolver: AutomationTextResolver): String =
        resolver.resolve(
            R.string.automation_definition_constraint_gps_summary,
